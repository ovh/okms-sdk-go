...
type ClientInterface interface {
	...
	ListSecretVersionV2(ctx context.Context, path string, params *ListSecretVersionV2Params, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) ListSecretVersionV2(ctx context.Context, path string, params *ListSecretVersionV2Params, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewListSecretVersionV2Request(c.Server, path, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewListSecretV2Request(server string, params *ListSecretV2Params) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.XKmsListIds != nil {
			var headerParam2 string

			headerParam2, err = runtime.StyleParamWithLocation("simple", false, "X-Kms-ListIds", runtime.ParamLocationHeader, *params.XKmsListIds)
			if err != nil {
				return nil, err
			}

			req.Header.Set("X-Kms-ListIds", headerParam2)
		}
...
func NewListSecretVersionV2Request(server string, path string, params *ListSecretVersionV2Params) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	ListSecretVersionV2WithResponse(ctx context.Context, path string, params *ListSecretVersionV2Params, reqEditors ...RequestEditorFn) (*ListSecretVersionV2HTTPResponse, error)
...
func (c *ClientWithResponses) ListSecretVersionV2WithResponse(ctx context.Context, path string, params *ListSecretVersionV2Params, reqEditors ...RequestEditorFn) (*ListSecretVersionV2HTTPResponse, error) {
	rsp, err := c.ListSecretVersionV2(ctx, path, params, reqEditors...)
	if err != nil {
		return nil, err
	}
