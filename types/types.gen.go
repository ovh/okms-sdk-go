...
type CreateImportServiceKeyRequest struct {
	...
	// Extractable Attribute indicating whether or not this key and information about it can be extracted. If false, key material cannot be exported in any form. Default: true. Once set to false it cannot be reverted to true.
...
type PatchServiceKeyRequest struct {
	// Extractable Attribute indicating whether or not this key and information about it can be extracted Set to false to permanently prevent plain or wrapped key export. Cannot be reverted to true once set to false.
	Extractable *bool `json:"extractable,omitempty"`
