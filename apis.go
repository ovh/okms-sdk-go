...
type SecretApiV2 interface {
	...
	ListSecretV2(ctx context.Context, okmsId uuid.UUID, pageSize *uint32, pageCursor *string) (*types.ListSecretV2ResponseWithHeaders, error)
	...
	ListSecretVersionV2(ctx context.Context, okmsId uuid.UUID, path string, pageSize *uint32, pageCursor *string) (*types.ListSecretVersionV2ResponseWithHeaders, error)
