...
func (_m *APIMock) DeleteSecretVersions(ctx context.Context, path string, versions []int32) error {
...
func (_c *APIMock_DeleteSecretVersions_Call) Run(run func(ctx context.Context, path string, versions []int32)) *APIMock_DeleteSecretVersions_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIMock_DeleteSecretVersions_Call) RunAndReturn(run func(context.Context, string, []int32) error) *APIMock_DeleteSecretVersions_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *APIMock) GetSecretRequest(ctx context.Context, path string, version *int32) (*types.GetSecretResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *int32) (*types.GetSecretResponse, error)); ok {
		return rf(ctx, path, version)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *int32) *types.GetSecretResponse); ok {
...
func (_c *APIMock_GetSecretRequest_Call) Run(run func(ctx context.Context, path string, version *int32)) *APIMock_GetSecretRequest_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*int32))
	})
	return _c
...
func (_c *APIMock_GetSecretRequest_Call) RunAndReturn(run func(context.Context, string, *int32) (*types.GetSecretResponse, error)) *APIMock_GetSecretRequest_Call {
	_c.Call.Return(run)
	return _c
}

// GetSecretSubkeys provides a mock function with given fields: ctx, path, depth, version
func (_m *APIMock) GetSecretSubkeys(ctx context.Context, path string, depth *int32, version *int32) (*types.GetSecretSubkeysResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *int32, *int32) (*types.GetSecretSubkeysResponse, error)); ok {
		return rf(ctx, path, depth, version)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *int32, *int32) *types.GetSecretSubkeysResponse); ok {
...
func (_c *APIMock_GetSecretSubkeys_Call) Run(run func(ctx context.Context, path string, depth *int32, version *int32)) *APIMock_GetSecretSubkeys_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIMock_GetSecretSubkeys_Call) RunAndReturn(run func(context.Context, string, *int32, *int32) (*types.GetSecretSubkeysResponse, error)) *APIMock_GetSecretSubkeys_Call {
	_c.Call.Return(run)
	return _c
}
...
// PostSecretDestroy provides a mock function with given fields: ctx, path, versions
func (_m *APIMock) PostSecretDestroy(ctx context.Context, path string, versions []int32) error {
	ret := _m.Called(ctx, path, versions)

	if len(ret) == 0 {
		panic("no return value specified for PostSecretDestroy")
	}
...
// APIMock_PostSecretDestroy_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PostSecretDestroy'
type APIMock_PostSecretDestroy_Call struct {
	*mock.Call
}

// PostSecretDestroy is a helper method to define mock.On call
//   - ctx context.Context
//   - path string
//   - versions []int32
func (_e *APIMock_Expecter) PostSecretDestroy(ctx interface{}, path interface{}, versions interface{}) *APIMock_PostSecretDestroy_Call {
	return &APIMock_PostSecretDestroy_Call{Call: _e.mock.On("PostSecretDestroy", ctx, path, versions)}
}

func (_c *APIMock_PostSecretDestroy_Call) Run(run func(ctx context.Context, path string, versions []int32)) *APIMock_PostSecretDestroy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].([]int32))
	})
	return _c
...
func (_c *APIMock_PostSecretDestroy_Call) Return(_a0 error) *APIMock_PostSecretDestroy_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *APIMock_PostSecretDestroy_Call) RunAndReturn(run func(context.Context, string, []int32) error) *APIMock_PostSecretDestroy_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *APIMock) PostSecretUndelete(ctx context.Context, path string, versions []int32) error {
	ret := _m.Called(ctx, path, versions)
...
func (_c *APIMock_PostSecretUndelete_Call) Run(run func(ctx context.Context, path string, versions []int32)) *APIMock_PostSecretUndelete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].([]int32))
	})
	return _c
...
func (_c *APIMock_PostSecretUndelete_Call) RunAndReturn(run func(context.Context, string, []int32) error) *APIMock_PostSecretUndelete_Call {
	_c.Call.Return(run)
	return _c
}
