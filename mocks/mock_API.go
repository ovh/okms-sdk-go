...
func (_m *APIMock) ListSecretV2(ctx context.Context, pageSize *uint32, pageNumber *uint32) (*[]types.GetSecretV2Response, error) {
	...
	var r0 *[]types.GetSecretV2Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *uint32, *uint32) (*[]types.GetSecretV2Response, error)); ok {
		return rf(ctx, pageSize, pageNumber)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *uint32, *uint32) *[]types.GetSecretV2Response); ok {
...
func (_c *APIMock_ListSecretV2_Call) RunAndReturn(run func(context.Context, *uint32, *uint32) (*[]types.GetSecretV2Response, error)) *APIMock_ListSecretV2_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *APIMock) PostSecretDestroy(ctx context.Context, path string, versions []uint32) error {
	ret := _m.Called(ctx, path, versions)
...
func (_c *APIMock_PostSecretDestroy_Call) Run(run func(ctx context.Context, path string, versions []uint32)) *APIMock_PostSecretDestroy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].([]uint32))
	})
	return _c
...
func (_c *APIMock_PostSecretDestroy_Call) RunAndReturn(run func(context.Context, string, []uint32) error) *APIMock_PostSecretDestroy_Call {
	_c.Call.Return(run)
	return _c
}
