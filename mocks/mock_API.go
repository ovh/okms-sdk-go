...
func (_m *APIMock) ListSecretV2(ctx context.Context, pageSize *uint32, pageCursor *string) (*types.ListSecretV2ResponseWithHeaders, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *uint32, *string) (*types.ListSecretV2ResponseWithHeaders, error)); ok {
		return rf(ctx, pageSize, pageCursor)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *uint32, *string) *types.ListSecretV2ResponseWithHeaders); ok {
...
func (_c *APIMock_ListSecretV2_Call) RunAndReturn(run func(context.Context, *uint32, *string) (*types.ListSecretV2ResponseWithHeaders, error)) *APIMock_ListSecretV2_Call {
	_c.Call.Return(run)
	return _c
}

// ListSecretVersionV2 provides a mock function with given fields: ctx, path, pageSize, pageCursor
func (_m *APIMock) ListSecretVersionV2(ctx context.Context, path string, pageSize *uint32, pageCursor *string) (*types.ListSecretVersionV2ResponseWithHeaders, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *uint32, *string) (*types.ListSecretVersionV2ResponseWithHeaders, error)); ok {
		return rf(ctx, path, pageSize, pageCursor)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *uint32, *string) *types.ListSecretVersionV2ResponseWithHeaders); ok {
...
func (_c *APIMock_ListSecretVersionV2_Call) RunAndReturn(run func(context.Context, string, *uint32, *string) (*types.ListSecretVersionV2ResponseWithHeaders, error)) *APIMock_ListSecretVersionV2_Call {
	_c.Call.Return(run)
	return _c
}
